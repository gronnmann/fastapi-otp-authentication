...
class OTPDatabase[UserType]:
    ...
    Example:
        ...
        async def get_otp_db(
            ...
            return OTPDatabase(session, User, Blacklist)
        ```
    """

    def __init__(
        self, session: AsyncSession, user_model: type[UserType], blacklist_model: type[Any]
    ) -> None:
        """
